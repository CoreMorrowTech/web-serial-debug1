...
; (function () {
    ...
    class BlocklyProgramming {
            ...
            this.blockDefinitions.serial = {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        previousStatement: null,
                        nextStatement: null,
                        tooltip: '通过串口发送十六进制数据',
                        helpUrl: '',
                        code: 'await com.SendData(%1.split(\' \').map(h => parseInt(h, 16)));\n'
                    }
                ]
            };
                ...
                blocks: [
                    {
                        ...
                        args: [
                            { type: 'input_value', name: 'REMOTE_IP', check: 'String' },
                            { type: 'input_value', name: 'REMOTE_PORT', check: 'Number' },
                            { type: 'input_value', name: 'LOCAL_IP', check: 'String' },
                            { type: 'input_value', name: 'LOCAL_PORT', check: 'Number' }
                        ],
                        previousStatement: null,
                        nextStatement: null,
                        tooltip: '打开UDP连接',
            ...
            this.blockDefinitions.data = {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        message: '十六进制 %1',
                        args: [
                            { type: 'field_input', name: 'HEX', text: '48 65 6C 6C 6F' }
                        ],
                        output: 'String',
                        tooltip: '十六进制数据',
                        helpUrl: '',
        ...
        createBlockHTML(block, color) {
            return `
                <div class="toolbox-block p-2 m-1 border rounded" 
                    ...
                    <div class="block-tooltip" style="display: none;">${block.tooltip}</div>
                </div>
            `;
        }
        ...
        setupDragAndDrop() {
            ...
            if (!toolboxContent || !workspaceContent) return;
            ...
            let blockHTML = `
                ...
                if (arg) {
                    if (arg.type === 'field_input') {
                        ...
                        return `<span class="input-placeholder" data-arg="${argIndex}">___</span>`;
                    }
                }
                return '___';
            })}</span>
